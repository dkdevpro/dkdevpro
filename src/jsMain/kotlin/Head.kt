...
fun Head() {
	...
	Script(src = "https://www.googletagmanager.com/gtag/js?id=GTM-TLKF992", mode = ScriptMode.ASYNC)
	Script(
		content = "function gtag(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],gtag('js',new Date),gtag('config','GTM-TLKF992')"
	)
}
